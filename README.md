<!-- BANNER SUPERIOR -->
<div align="center">
  <img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:6366F1,100:8B5CF6&height=200&section=header&text=Henrique%20Gambin%20Di%20Célio&fontSize=42&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Engenharia%20de%20Software%20•%20Desenvolvedor%20Full-Stack&descAlignY=58&descSize=18" />
</div>

<!-- TÍTULO DIGITANDO -->
<div align="center">
  <a href="https://git.io/typing-svg">
    <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=24&duration=3000&pause=1000&color=8B5CF6&center=true&vCenter=true&width=600&lines=Desenvolvedor+Full-Stack;Estudante+de+Engenharia+de+Software;Front-end+%7C+Back-end+%7C+Web;Sempre+aprendendo+algo+novo" alt="Typing SVG" />
  </a>
</div>
...
```typescript
const henrique = {
  nome: "Henrique Gambin Di Célio",
  idade: 22,
  formacao: "Administração (USF Bragança Paulista)",
  cursando: "Engenharia de Software — PUC-Campinas (6º semestre)",
  areas: ["Front-end", "Back-end", "Full-Stack"],
  buscando: "Novos desafios e oportunidades na área de tecnologia",
  filosofia: "Transformar ideias em código e código em soluções 🚀",
};
```

- 🎓 Formado em **Administração** e cursando **Engenharia de Software** na PUC-Campinas
- 💻 Foco em desenvolvimento **Web Full-Stack** (Front-end + Back-end)
- 🌱 Sempre estudando novas tecnologias e boas práticas
- 📫 Como me encontrar: os links estão ali embaixo 👇
